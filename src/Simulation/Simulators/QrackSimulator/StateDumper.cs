...
namespace Microsoft.Quantum.Simulation.Simulators
{
    public partial class QrackSimulator
    {
        ...
        [DllImport(QRACKSIM_DLL_NAME, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Dump")]
        private static extern void sim_Dump(uint id, DumpCallback callback);

        [DllImport(QRACKSIM_DLL_NAME, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DumpQubits")]
        ...
        public abstract class StateDumper
        {
            ...
            /// </summary>
            public QrackSimulator Simulator { get; }
