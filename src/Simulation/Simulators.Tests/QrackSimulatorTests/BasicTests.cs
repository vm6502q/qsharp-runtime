...
namespace Microsoft.Quantum.Simulation.Simulators.Tests
{
    public partial class QrackSimulatorTests
    {
        ...
        private void TestOne<T>(QrackSimulator qsim, T gate, Action<T, IQArray<Qubit>, IQArray<Qubit>> action)
        {
        ...
        {
            using (var qsim = new QrackSimulator(throwOnReleasingQubitsNotInZeroState: false))
            {
